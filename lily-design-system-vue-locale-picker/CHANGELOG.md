...
**Package renamed: `lily-design-system-vue-locale-picker` → `@lilydesignsystem/vue-locale-picker`.** npm scoped packages
...
relative to `lily-design-system-vue-locale-picker`'s last published version (`0.2.0`);
