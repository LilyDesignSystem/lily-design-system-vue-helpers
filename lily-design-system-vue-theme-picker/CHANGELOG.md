...
**Package renamed: `lily-design-system-vue-theme-picker` → `@lilydesignsystem/vue-theme-picker`.** npm scoped packages
...
relative to `lily-design-system-vue-theme-picker`'s last published version (`0.2.0`);
